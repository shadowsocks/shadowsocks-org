...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Of course, remember to execute <code>sysctl -p</code> to reload the config at runtime.</p>`,16),o=[l];function t(c,r,i,d,h,m){return n(),e("div",null,o)}var u=s(p,[["render",t]]);export{C as __pageData,u as default};
