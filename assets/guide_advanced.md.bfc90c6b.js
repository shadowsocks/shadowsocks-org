...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Of course, remember to execute <code>sysctl -p</code> to reload the config at runtime.</p>`,17),l=[o];function t(c,r,i,d,h,A){return n(),e("div",null,l)}var C=s(p,[["render",t]]);export{u as __pageData,C as default};
